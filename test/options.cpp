...
TEST_CASE("Basic options", "[options]") {
  ...
  options.add_options()("long", "a long option")("s,short", "a short option")(
      "value", "an option with a value", cxxopts::value<std::string>())(
      "a,av", "a short option with a value",
      cxxopts::value<std::string>())("6,six", "a short number option")(
...
TEST_CASE("Short options", "[options]") {
  ...
  options.add_options()("a", "a short option", cxxopts::value<std::string>());
...
TEST_CASE("All positional", "[positional]") {
  ...
  options.add_options()("positional", "Positional parameters",
...
TEST_CASE("No positional with extras", "[positional]") {
  ...
  options.add_options()("dummy", "oh no", cxxopts::value<std::string>());
...
TEST_CASE("Positional not valid", "[positional]") {
  ...
  options.add_options()("long", "a long option", cxxopts::value<std::string>());
...
TEST_CASE("Empty with implicit value", "[implicit]") {
  ...
  options.add_options()("implicit", "Has implicit",
                        cxxopts::value<std::string>()->implicit_value("foo"));
...
TEST_CASE("Default values", "[default]") {
  ...
  options.add_options()("default", "Has implicit",
...
TEST_CASE("Parse into a reference", "[reference]") {
  ...
  options.add_options()("ref", "A reference", cxxopts::value(value));
...
TEST_CASE("Integers", "[options]") {
  ...
  options.add_options()("positional", "Integers",
...
TEST_CASE("Integer bounds", "[integer]") {
  ...
  options.add_options()("positional", "Integers",
                        cxxopts::value<std::vector<int8_t>>());
...
TEST_CASE("Floats", "[options]") {
  ...
  options.add_options()("double", "Double precision", cxxopts::value<double>())(
...
TEST_CASE("Booleans", "[boolean]") {
  cxxopts::Options options("parses_floats", "parses floats correctly");
  options.add_options()("bool", "A Boolean", cxxopts::value<bool>())(
      "debug", "Debugging", cxxopts::value<bool>())("timing", "Timing",
                                                    cxxopts::value<bool>())(
      "verbose", "Verbose", cxxopts::value<bool>())("dry-run", "Dry Run",
                                                    cxxopts::value<bool>())(
...
TEST_CASE("std::optional", "[optional]") {
  ...
  options.add_options()("optional", "an optional option",
